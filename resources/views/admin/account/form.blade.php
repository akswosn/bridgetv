...
<div class="content">
    ...
    <div class="table-wrap">
        <table width="100%" class="table-row" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input type="radio" name="type" value="0" class="form-radio" {{ old('type')=='0'? 'checked' : '' }}> 일반
                    </label>
                    <label>
                        <input type="radio" name="type" value="1" class="form-radio" {{ old('type')=='1'? 'checked' : '' }}> 마스터
                    </label>
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input type="text" id="userid" name="userid" class="form-text" placeholder="아이디를 입력해주세요." value="{{ old('userid') }}">
                    </label>
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input type="text" id="name" name="name" class="form-text" placeholder="이름을 입력해주세요." value="{{ old('name') }}">
                    </label>
    ...
    <div class="btn-wrap">
            <button type="button" class="btn btn-write float-right" onclick="onAction()">관리자 아이디 추가하기</button>
    </div>
</div>
</form>
@stop
